...
import {
  ChartIcon, ChatBubbleIcon, CheckIcon, ClipIcon, CloseIcon, CompactIcon, CopyIcon,
  CycleIcon, DownloadIcon, ForkIcon, HistoryIcon, MicIcon, MoreIcon, PencilIcon, PinIcon,
  PlusIcon, RetryIcon, SearchIcon, LightningIcon, SpeakerIcon, SpeakerMuteIcon,
  TargetIcon, ThinkingIcon, TrashIcon, WarningIcon,
} from './HunterMiniIcons';
// Fase 5.2 — cards de resultado de ferramenta (ListarVagasCard, SalarioCard,
// etc. e o dispatcher ToolResultCard) viviam aqui dentro; extraídos pra
// jarvis/ToolResultCards.tsx. CompactFeedback também foi junto (mora perto
// de ChatGapItem, seu principal usuário) mas ChatMessageActions (abaixo,
// ainda neste arquivo) também precisa dele.
import { CompactFeedback, ToolResultCard } from './jarvis/ToolResultCards';
